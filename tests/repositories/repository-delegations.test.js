...
describe('DatabaseManager façade exposes every method the repositories delegate to', () => {
  const FACADE_METHODS = [
    // FileRepository
    'getFile', 'getFileInfo', 'getFiles', 'insertFile', 'updateFile', 'deleteFile',
    'getFileChannels', 'searchFiles', 'filterFiles', 'countFilesNeedingReanalysis',
    'getDistinctInstruments', 'getDistinctCategories', 'transaction',
    // RoutingRepository
    'insertRouting', 'insertSplitRoutings', 'getRoutingsByFile', 'getRoutingCountsByFiles',
    'deleteRoutingsByFile', 'deleteRoutingsByDevice',
    // InstrumentRepository (the reconciliation trio was the real-world gap)
    'findInstrumentById', 'getInstrumentsWithCapabilities', 'updateInstrumentById',
    'getInstrumentCapabilities', 'updateInstrumentCapabilities', 'updateInstrumentSettings',
    'getInstrumentSettings', 'getInstrumentsByDevice', 'deleteInstrumentSettingsByDevice',
    'findInstrumentByUsbSerial', 'findInstrumentByMac', 'findInstrumentByNormalizedName',
    'reconcileDeviceId', 'deduplicateByUsbSerial', 'saveSysExIdentity',
    'getAllInstrumentCapabilities',
    // PresetRepository
    'insertPreset', 'getPreset', 'getPresets', 'deletePreset', 'updatePreset',
    // SessionRepository
    'insertSession', 'getSession', 'getSessions', 'deleteSession',
    // PlaylistRepository
    'insertPlaylist', 'deletePlaylist', 'getPlaylists', 'getPlaylist', 'getPlaylistItems',
    'addPlaylistItem', 'removePlaylistItem', 'reorderPlaylistItem', 'updatePlaylistLoop',
    'clearPlaylistItems', 'updatePlaylistSettings',
    // LightingRepository
    'getLightingDevices', 'getLightingDevice', 'insertLightingDevice', 'updateLightingDevice',
    'deleteLightingDevice', 'getAllLightingRules', 'getLightingRulesForDevice',
    'insertLightingRule', 'updateLightingRule', 'deleteLightingRule', 'getLightingPresets',
    'insertLightingPreset', 'deleteLightingPreset',
    // DeviceSettingsRepository
    'getDeviceSettings', 'ensureDevice', 'updateDeviceSettings'
  ];
