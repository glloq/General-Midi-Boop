...
export default class LoopArrangementRepository {
  ...
  // Arrangements
  save(arr)             { return this.database.insertArrangement(arr); }
  findAll()             { return this.database.getArrangements(); }
  findById(id)          { return this.database.getArrangement(id); }
  update(id, fields)    { return this.database.updateArrangement(id, fields); }
  delete(id)            { return this.database.deleteArrangement(id); }
  ...
  // Blocks
  addBlock(block)       { return this.database.insertBlock(block); }
  findBlocks(trackId)   { return this.database.getBlocks(trackId); }
