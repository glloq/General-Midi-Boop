...
(function() {
    ...
    const PRESETS = [
        { id: 'piano_acoustic_88', label: 'Piano à queue (88 touches)', family_slug: 'keyboards', gm_programs: [0, 1, 2, 3], note_range_min: 21, note_range_max: 108, polyphony: 16 },
        { id: 'piano_electric_73', label: 'Piano électrique (73 touches)', family_slug: 'keyboards', gm_programs: [4, 5], note_range_min: 28, note_range_max: 100, polyphony: 16 },
        { id: 'harpsichord', label: 'Clavecin', family_slug: 'keyboards', gm_programs: [6], note_range_min: 29, note_range_max: 89, polyphony: 8 },
        { id: 'clavinet', label: 'Clavinet', family_slug: 'keyboards', gm_programs: [7], note_range_min: 28, note_range_max: 88, polyphony: 8 },
        { id: 'organ_hammond', label: 'Orgue Hammond (61 touches)', family_slug: 'keyboards', gm_programs: [16, 17, 18], note_range_min: 36, note_range_max: 96, polyphony: 16 },
        { id: 'organ_church', label: "Orgue d'église", family_slug: 'keyboards', gm_programs: [19], note_range_min: 36, note_range_max: 96, polyphony: 16 },
        { id: 'reed_organ', label: 'Harmonium', family_slug: 'keyboards', gm_programs: [20], note_range_min: 36, note_range_max: 96, polyphony: 16 },

        { id: 'celesta', label: 'Célesta (5 octaves)', family_slug: 'chromatic_percussion', gm_programs: [8], note_range_min: 60, note_range_max: 108, polyphony: 8 },
        { id: 'glockenspiel', label: 'Glockenspiel (2,5 octaves)', family_slug: 'chromatic_percussion', gm_programs: [9], note_range_min: 79, note_range_max: 108, polyphony: 4 },
        { id: 'music_box', label: 'Boîte à musique', family_slug: 'chromatic_percussion', gm_programs: [10], note_range_min: 72, note_range_max: 96, polyphony: 4 },
        { id: 'vibraphone', label: 'Vibraphone (3 octaves)', family_slug: 'chromatic_percussion', gm_programs: [11], note_range_min: 53, note_range_max: 89, polyphony: 6 },
        { id: 'marimba', label: 'Marimba (4,3 octaves)', family_slug: 'chromatic_percussion', gm_programs: [12], note_range_min: 45, note_range_max: 96, polyphony: 4 },
        { id: 'xylophone', label: 'Xylophone (3,5 octaves)', family_slug: 'chromatic_percussion', gm_programs: [13], note_range_min: 65, note_range_max: 108, polyphony: 4 },
        { id: 'tubular_bells', label: 'Cloches tubulaires', family_slug: 'chromatic_percussion', gm_programs: [14], note_range_min: 60, note_range_max: 89, polyphony: 8 },
        { id: 'dulcimer', label: 'Cymbalum / dulcimer', family_slug: 'chromatic_percussion', gm_programs: [15], note_range_min: 48, note_range_max: 84, polyphony: 4 },
        { id: 'timpani', label: 'Timbales (4 fûts)', family_slug: 'chromatic_percussion', gm_programs: [47], note_range_min: 36, note_range_max: 57, polyphony: 2 },
        { id: 'kalimba', label: 'Kalimba (lamellophone)', family_slug: 'chromatic_percussion', gm_programs: [108], note_range_min: 53, note_range_max: 84, polyphony: 4 },
        { id: 'agogo_bells', label: 'Cloches agogô / clochettes', family_slug: 'chromatic_percussion', gm_programs: [112, 113], note_range_min: 48, note_range_max: 96, polyphony: 4 },
        { id: 'steel_drums', label: 'Steel drum', family_slug: 'chromatic_percussion', gm_programs: [114], note_range_min: 48, note_range_max: 96, polyphony: 2 },
        { id: 'woodblock', label: 'Woodblock / claves', family_slug: 'chromatic_percussion', gm_programs: [115], note_range_min: 48, note_range_max: 96, polyphony: 2 },
        { id: 'taiko', label: 'Taiko', family_slug: 'chromatic_percussion', gm_programs: [116], note_range_min: 48, note_range_max: 96, polyphony: 4 },
        { id: 'melodic_tom', label: 'Tom mélodique', family_slug: 'chromatic_percussion', gm_programs: [117], note_range_min: 48, note_range_max: 96, polyphony: 4 },
        ...
        { id: 'orchestra_hit', label: 'Orchestra hit', family_slug: 'ensembles', gm_programs: [55], note_range_min: 36, note_range_max: 96, polyphony: 1 },

        { id: 'trumpet', label: 'Trompette en Si♭', family_slug: 'brass', gm_programs: [56, 59], note_range_min: 52, note_range_max: 84, polyphony: 1 },
        { id: 'trombone', label: 'Trombone ténor', family_slug: 'brass', gm_programs: [57], note_range_min: 40, note_range_max: 72, polyphony: 1 },
        { id: 'tuba', label: 'Tuba', family_slug: 'brass', gm_programs: [58], note_range_min: 28, note_range_max: 58, polyphony: 1 },
        { id: 'french_horn', label: "Cor d'harmonie en Fa", family_slug: 'brass', gm_programs: [60], note_range_min: 34, note_range_max: 77, polyphony: 1 },
        { id: 'brass_section', label: 'Section de cuivres', family_slug: 'brass', gm_programs: [61, 62, 63], note_range_min: 40, note_range_max: 84, polyphony: 8 },

        { id: 'accordion', label: 'Accordéon', family_slug: 'reeds', gm_programs: [21, 23], note_range_min: 41, note_range_max: 96, polyphony: 8 },
        { id: 'harmo_diatonic_c', label: 'Harmonica diatonique — Do (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 60, note_range_max: 96, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'C' } },
        { id: 'harmo_diatonic_g', label: 'Harmonica diatonique — Sol (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 55, note_range_max: 91, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'G' } },
        { id: 'harmo_diatonic_a', label: 'Harmonica diatonique — La (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 57, note_range_max: 93, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'A' } },
        { id: 'harmo_diatonic_d', label: 'Harmonica diatonique — Ré (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 62, note_range_max: 98, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'D' } },
        { id: 'harmo_diatonic_f', label: 'Harmonica diatonique — Fa (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 65, note_range_max: 101, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'F' } },
        { id: 'harmo_diatonic_as', label: 'Harmonica diatonique — Si♭ (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 58, note_range_max: 94, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'A#' } },
        { id: 'harmo_diatonic_e', label: 'Harmonica diatonique — Mi (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 64, note_range_max: 100, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'E' } },
        { id: 'harmo_diatonic_ds', label: 'Harmonica diatonique — Mi♭ (10 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 63, note_range_max: 99, polyphony: 1, harmonica_config: { type: 'diatonic', key: 'D#' } },
        { id: 'harmo_chromatic_c_12', label: 'Harmonica chromatique — Do (12 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 60, note_range_max: 96, polyphony: 1, harmonica_config: { type: 'chromatic', key: 'C' } },
        { id: 'harmo_chromatic_c_16', label: 'Harmonica chromatique — Do (16 trous)', family_slug: 'reeds', gm_programs: [22], note_range_min: 48, note_range_max: 96, polyphony: 1, harmonica_config: { type: 'chromatic', key: 'C' } },
        { id: 'soprano_sax', label: 'Saxophone soprano', family_slug: 'reeds', gm_programs: [64], note_range_min: 56, note_range_max: 87, polyphony: 1 },
        { id: 'alto_sax', label: 'Saxophone alto', family_slug: 'reeds', gm_programs: [65], note_range_min: 49, note_range_max: 80, polyphony: 1 },
        { id: 'tenor_sax', label: 'Saxophone ténor', family_slug: 'reeds', gm_programs: [66], note_range_min: 44, note_range_max: 75, polyphony: 1 },
        { id: 'baritone_sax', label: 'Saxophone baryton', family_slug: 'reeds', gm_programs: [67], note_range_min: 36, note_range_max: 68, polyphony: 1 },
        { id: 'oboe', label: 'Hautbois', family_slug: 'reeds', gm_programs: [68], note_range_min: 58, note_range_max: 91, polyphony: 1 },
        { id: 'english_horn', label: 'Cor anglais', family_slug: 'reeds', gm_programs: [69], note_range_min: 52, note_range_max: 81, polyphony: 1 },
        { id: 'bassoon', label: 'Basson', family_slug: 'reeds', gm_programs: [70], note_range_min: 34, note_range_max: 72, polyphony: 1 },
        { id: 'clarinet', label: 'Clarinette en Si♭', family_slug: 'reeds', gm_programs: [71], note_range_min: 50, note_range_max: 91, polyphony: 1 },
        { id: 'bagpipe', label: 'Cornemuse', family_slug: 'reeds', gm_programs: [109], note_range_min: 62, note_range_max: 86, polyphony: 1 },
        { id: 'shanai', label: 'Shehnai / bombarde', family_slug: 'reeds', gm_programs: [111], note_range_min: 62, note_range_max: 86, polyphony: 1 },

        { id: 'piccolo', label: 'Piccolo', family_slug: 'winds', gm_programs: [72], note_range_min: 74, note_range_max: 108, polyphony: 1 },
        { id: 'flute', label: 'Flûte traversière', family_slug: 'winds', gm_programs: [73], note_range_min: 60, note_range_max: 96, polyphony: 1 },
        { id: 'recorder', label: 'Flûte à bec', family_slug: 'winds', gm_programs: [74], note_range_min: 60, note_range_max: 86, polyphony: 1 },
        { id: 'pan_flute', label: 'Flûte de pan', family_slug: 'winds', gm_programs: [75], note_range_min: 60, note_range_max: 84, polyphony: 1 },
        { id: 'blown_bottle', label: 'Bouteille soufflée', family_slug: 'winds', gm_programs: [76], note_range_min: 60, note_range_max: 84, polyphony: 1 },
        { id: 'shakuhachi', label: 'Shakuhachi', family_slug: 'winds', gm_programs: [77], note_range_min: 55, note_range_max: 84, polyphony: 1 },
        { id: 'whistle', label: 'Sifflet', family_slug: 'winds', gm_programs: [78], note_range_min: 60, note_range_max: 96, polyphony: 1 },
        { id: 'ocarina', label: 'Ocarina', family_slug: 'winds', gm_programs: [79], note_range_min: 60, note_range_max: 84, polyphony: 1 },

        { id: 'synth_lead', label: 'Synthé lead (solo)', family_slug: 'synths', gm_programs: [80, 81, 82, 83, 84, 85, 86, 87], note_range_min: 48, note_range_max: 91, polyphony: 1 },
        { id: 'synth_pad', label: 'Synthé nappe (pad)', family_slug: 'synths', gm_programs: [88, 89, 90, 91, 92, 93, 94, 95], note_range_min: 36, note_range_max: 96, polyphony: 8 },
        { id: 'synth_fx', label: 'Synthé FX / texture', family_slug: 'synths', gm_programs: [96, 97, 98, 99, 100, 101, 102, 103], note_range_min: 36, note_range_max: 96, polyphony: 4 }
    ];
    ...
    function getPresetsForProgram(gmProgram, channel) {
        ...
        return PRESETS
            .filter(p => p.gm_programs.indexOf(gmProgram) !== -1)
            .map(normalize);
    }
    ...
    function filterStringPresetsByGmProgram(gmProgram) {
        ...
        return PRESETS
            .filter(p => p.string_geometry && p.gm_programs.indexOf(gmProgram) !== -1)
            .map(flattenString);
    }
    ...
    function filterStringPresetsByFamily(slug) {
        if (!slug) return [];
        return PRESETS
            .filter(p => p.string_geometry && p.family_slug === slug)
            .map(flattenString);
    }
