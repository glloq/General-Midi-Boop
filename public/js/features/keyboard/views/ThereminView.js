...
(function () {
    ...
    const NOTE_LO = 48, NOTE_HI = 84;   // C3..C6
    const PAD_W = 480, PAD_H = 300;     // fallback geometry (jsdom has no layout)
    ...
    class ThereminView extends InstrumentView {
        ...
        mount(ctx) {
            ...
            this._onMove = (e) => { if (this._active) this._update(e); };
        ...
        _xyRatio(e) {
            const r = this._root.getBoundingClientRect
                ? this._root.getBoundingClientRect() : { left: 0, top: 0, width: 0, height: 0 };
