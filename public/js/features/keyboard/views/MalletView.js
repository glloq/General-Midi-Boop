...
(function () {
    ...
    const DEFAULT_SKIN = {
        nat: '#d8b46a', acc: '#7a5a2a', text: '#222', accText: '#fff',
    };
    const MALLET_SKINS = {
    ...
    class MalletView extends InstrumentView {
        ...
        mount(ctx) {
            ...
            const gmProgram = modal.selectedDeviceCapabilities?.gm_program
                ?? modal.selectedDevice?.gm_program ?? null;
