...
(function () {
  ...
  class PianoSliderView extends InstrumentView {
    ...
    _syncWind(modal) {
      let preset = this.ctx && this.ctx.options && this.ctx.options.windPreset;
    ...
    willPlayNote(midi, velocity, opts) {
      ...
      const factor = ARTICULATION_FACTORS[art] != null ? ARTICULATION_FACTORS[art] : 1.0;
