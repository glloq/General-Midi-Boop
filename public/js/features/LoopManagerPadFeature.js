...
(function () {
    ...
    class LoopManagerPadFeature {
        ...
        constructor(modal) {
            ...
            this.view = typeof LoopManagerPadView !== 'undefined'
                ? new LoopManagerPadView(this)
                : null;
        }
        ...
        renderTabHtml()      { return this.view?.renderTabHtml() ?? ''; }
        async initSynth()    { return this.view?.initSynth(); }
        clearLongPress()     { return this.view?.clearLongPress(); }
        renderGrid()         { return this.view?.renderGrid(); }
