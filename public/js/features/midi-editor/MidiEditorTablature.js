...
(function() {
    ...
    class MidiEditorTablature {
        constructor(modal) {
            ...
            this.specializedEditors = typeof MidiEditorSpecializedEditors !== 'undefined'
                ...
                : null;
            this.channelPopover = typeof MidiEditorChannelSettingsPopover !== 'undefined'
    ...
    _closeChannelSettingsPopover()                  { return this.channelPopover?.closePopover(); }
    _toggleChannelSettingsPopover(channel, btn)     { return this.channelPopover?.togglePopover(channel, btn); }
    _deleteChannel(channel)                         { return this.channelPopover?.deleteChannel(channel); }
