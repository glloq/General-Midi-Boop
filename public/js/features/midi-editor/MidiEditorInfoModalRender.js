...
(function () {
    ...
    class MidiEditorInfoModalRender {
        ...
        renderBody(textData, channelData, metaData, ls) {
            ...
            html += this.section('📊 Statistiques', `
            ...
            if (ccEntries.length > 0) {
                ...
                html += this.section('🎛 Contrôleurs (CC)', `
                    <table class="file-info-table">
            ...
            if (ls.progChanges.length > 0) {
                ...
                html += this.section('🔄 Changements de programme', `
                    <table class="file-info-table">
            ...
            if (others.length > 0) {
                ...
                html += this.section('📄 Autres textes', `
                    <table class="file-info-table">
