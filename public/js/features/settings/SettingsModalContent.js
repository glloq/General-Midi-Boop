    ...
    SettingsModalContent.renderContent = function() {
        ...
        return `
            ...
            <div class="settings-group">
                ...
                <div class="settings-section" style="margin-top: 24px;">
                    <h3 style="margin: 0 0 16px 0; font-size: 16px; color: var(--text-primary, #333);">🧪 ${i18n.t('settings.pianoRollV2.title') || 'Piano Roll V2 (expérimental)'}</h3>
                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px;">
                        <div style="flex: 1;">
            ...
            <div class="settings-group" style="margin-top: 28px;">
                ...
                <!-- Bouton Loop Creator -->
                <div class="settings-section" style="margin-top: 24px;">
                    <h3 style="margin: 0 0 16px 0; font-size: 16px; color: var(--text-primary, #333);">∞ ${i18n.t('settings.loopCreatorButton.title') || 'Bouton Loop Creator'}</h3>
                    <div style="display: flex; align-items: center; justify-content: space-between; gap: 16px;">
                        <div style="flex: 1;">
                            <p style="margin: 0 0 4px 0; font-size: 14px; color: var(--text-primary, #333);">${i18n.t('settings.loopCreatorButton.enable') || 'Afficher le bouton Loop Creator'}</p>
                            <p style="margin: 0; font-size: 12px; color: var(--text-secondary, #666);">${i18n.t('settings.loopCreatorButton.description') || 'Affiche le bouton ∞ pour créer et jouer des boucles MIDI en direct'}</p>
                        </div>
                        <label class="toggle-switch" style="position: relative; display: inline-block; width: 60px; height: 30px;">
                            <input type="checkbox" id="showLoopCreatorButtonToggle" ${this.settings.showLoopCreatorButton ? 'checked' : ''}
                                   style="opacity: 0; width: 0; height: 0;">
                            <span class="toggle-slider" style="
                                position: absolute;
                                cursor: pointer;
