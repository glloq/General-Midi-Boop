...
class CCPitchbendEditorInteractions {
        ...
        switch (this.parent.currentTool) {
            ...
            case 'line':
                if (!this.parent.lineStart) {
                    ...
                    this.parent.createLine(this.parent.lineStart.ticks, this.parent.lineStart.value, ticks, value);
    ...
    handleMouseMove(e) {
        ...
        if (this.parent.isDrawing && this.parent.currentTool === 'draw') {
            ...
            const advanced = this.parent.lastDrawTicks === null
                || Math.abs(snappedTicks - this.parent.lastDrawTicks) >= this.parent.options.grid * this.parent.drawDensityMultiplier;
            if (advanced) {
                this.parent.addEvent(ticks, value, this.parent.currentChannel, false);
        ...
        } else if (this.parent.dragStart && (this.parent.currentTool === 'select' || this.parent.currentTool === 'move')) {
