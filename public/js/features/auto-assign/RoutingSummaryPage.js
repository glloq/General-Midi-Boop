...
if (window.RoutingSummaryPreviewControls) {
  ...
  console.error('[RoutingSummaryPage] RoutingSummaryPreviewControls mixin missing — preview/minimap methods will not be available. Check script load order in index.html.');
}
