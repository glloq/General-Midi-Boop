...
(function () {
  ...
  class BaseLaneEditor {
    ...
    constructor(container, options = {}) {
      ...
      const defaultHeight =
        typeof MidiEditorConstants !== 'undefined' ? MidiEditorConstants.defaultEditorHeight : 150;
    ...
    _getDataArray() {
      return this[this._dataField()] || [];
    }

    /** Replace the data array in-place. */
    _setDataArray(arr) {
      this[this._dataField()] = arr || [];
    }
    ...
    _snapshotData() {
      return this._cloneArr(this._getDataArray());
    }
    ...
    notifyChange() {
      if (typeof this.options.onChange === 'function') {
        try {
          this.options.onChange(this._getDataArray());
        } catch (_) {
          /* best-effort */
        }
      }
