...
class WindInstrumentDatabase {
    ...
    static PRESETS = {
        ...
        75: { name: 'Pan Flute',      category: 'pipe', gmProgram: 75,
              ...
              breathCapacity: 4.0, typicalRestInterval: 2.0 },
        76: { name: 'Blown Bottle',   category: 'pipe', gmProgram: 76,
              rangeMin: 60, rangeMax: 84, comfortMin: 62, comfortMax: 79,
              breathCapacity: 3.0, typicalRestInterval: 2.0 },
    ...
    // ========================================================================
    // WIND CCs (common to all wind instruments)
    // ========================================================================

    static WIND_CCS = [
        { cc: 1,  name: 'Modulation',    role: 'vibrato' },
        { cc: 2,  name: 'Breath',        role: 'dynamics' },
        { cc: 5,  name: 'Portamento',    role: 'glide' },
        { cc: 7,  name: 'Volume',        role: 'master' },
        { cc: 10, name: 'Pan',           role: 'position' },
        { cc: 11, name: 'Expression',    role: 'dynamics' },
        { cc: 74, name: 'Filter Cutoff', role: 'timbre' },
        { cc: 76, name: 'Vibrato Rate',  role: 'vibrato' },
        { cc: 77, name: 'Vibrato Depth', role: 'vibrato' },
        { cc: 78, name: 'Vibrato Delay', role: 'vibrato' },
        { cc: 91, name: 'Reverb',        role: 'effect' },
    ];
