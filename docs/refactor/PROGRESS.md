...
| Dernier lot terminé | P1-4.2 |
| Prochain lot suggéré | **P1-4.5b** : implémenter `NobleBleAdapter` réel + rewire `BluetoothManager` pour consommer `BluetoothPort` en injection. Toutes les autres todos Phase 4 sont closes. |
